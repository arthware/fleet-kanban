...
import {
	applyTaskPromptComposerCompletion,
	buildMentionInsertText,
	detectActiveTaskPromptComposerToken,
...
export function TaskPromptComposer({
	...
	const activeToken = useMemo(() => {
		const token = detectActiveTaskPromptComposerToken(value, cursorIndex);
	...
	const applySuggestion = useCallback(
		(item: InlineCompletionItem) => {
			...
			const next = applyTaskPromptComposerCompletion(value, activeToken, insertText);
